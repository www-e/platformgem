...
export default async function CourseDetailPage({ params }: { params: Promise<{ courseId: string }> }) {
  ...
  return (
    <div>
      ...
      <p className="text-muted-foreground mb-8">Manage lessons for this course.</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="lg:col-span-2">
          <Card className="bg-card">
            <CardHeader>
              <CardTitle>Current Lessons ({course.lessons.length})</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {course.lessons.length === 0 ? (
                  <p className="text-muted-foreground p-8 text-center">No lessons have been added yet.</p>
                ) : (
