  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold">تقرير الإيرادات</h2>
          <p className="text-muted-foreground">
            تتبع أرباحك من دوراتك التعليمية
          </p>
        </div>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {new Intl.NumberFormat('ar-EG', {
                ...
                currency: 'EGP',
                minimumFractionDigits: 0
              }).format(earningsData.paymentStats.averagePayment)}
            </div>
            <p className="text-xs text-muted-foreground">
              قيمة الدفع الواحد
            </p>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              {earningsData.topCourses.map((course, index) => (
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        {course.enrollments} تسجيل • {new Intl.NumberFormat('ar-EG', {
                          style: 'currency',
                          currency: 'EGP',
                          minimumFractionDigits: 0
                        }).format(course.price)}
              ...
              {earningsData.topCourses.length === 0 && (
                <div className="text-center py-4">
                  <BookOpen className="h-8 w-8 mx-auto text-muted-foreground mb-2" />
                  <p className="text-sm text-muted-foreground">لا توجد إيرادات بعد</p>
                </div>
              )}
            </div>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-6">
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center p-4 border rounded-lg">
                  <div className="text-2xl font-bold text-blue-600">
                    {earningsData.paymentStats.totalPayments}
                  </div>
                ...
                <div className="text-center p-4 border rounded-lg">
                  <div className="text-2xl font-bold text-green-600">
                    {earningsData.paymentStats.conversionRate.toFixed(1)}%
                  </div>
              ...
              <div>
                <h4 className="font-medium mb-3">الأداء الشهري</h4>
                <div className="space-y-3">
                  {earningsData.monthlyData.slice(0, 6).map((month) => (
                    <div key={month.month} className="space-y-1">
                      ...
                      <div className="w-full bg-muted rounded-full h-1">
                        <div 
                          ...
                          style={{ 
                            width: `${Math.min((month.earnings / Math.max(...earningsData.monthlyData.map(m => m.earnings))) * 100, 100)}%` 
                          }}
                        ></div>
                      </div>
          ...
          <div className="space-y-3">
            ...
            {earningsData.recentPayments.length === 0 && (
              <div className="text-center py-8">
                ...
                <p className="text-muted-foreground">لا توجد مدفوعات حديثة</p>
              </div>
            )}
          </div>
        </CardContent>
